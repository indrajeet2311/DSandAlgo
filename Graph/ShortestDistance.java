...
// It is for the UnDirected Graph
class ShortestDistance {

    static void TopologicalSort(int node, Boolean visited[], Stack stack, ArrayList<ArrayList<Pair>> adj) {
    ...
    public static void main(String[] args) {
        ...
        ShortestDistance.shortestPath(0, adj, n);
